...
class Chatbot {
  ...
  List whatCanYouDo = [
    "Ich kann vieles, am besten kann ich dir jedoch bei der Erfassung menschlicher Daten helfen!",
    "Das weiß nur der, von dem ich programmiert wurde",
    "Tja, das weiß ich selbst noch nicht ganz genau, aber mit jedem tag werde ich verbessert, zumindest so lange Marlon noch genug Kaffee hat"
  ];
